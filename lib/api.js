...
BaseClient.extend( ApiClient.prototype, {
	...
	createWorker: function( options, fn ) {
		if ( options[ this.versionField ] === "latest" ) {
			return this.getLatest( options, function( error, version ) {
				...
				options = BaseClient.extend( {}, options );
	...
	getLatest: function( browser, fn ) {
		...
		process.nextTick(function() {
			fn( null, browser ? latest[ browserId ] : BaseClient.extend( {}, latest ) );
		});
	},
...
module.exports = {
	createClient: function ( settings ) {
		...
		BaseClient.extend( ApiClient.prototype, versionSettings);
