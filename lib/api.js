...
BaseClient.prototype.extend( ApiBaseClient.prototype, {
	...
	getLatest: function( browser, fn ) {
		...
		process.nextTick(function() {
			fn( null, browser ? latest[ browserId ] : this.extend( {}, latest ) );
		});
	},
...
ApiBaseClient.createVersion = function( version, prototype ) {
	...
	BaseClient.prototype.extend( ApiClient.prototype, prototype );
