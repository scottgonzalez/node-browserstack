...
util._extend( apiClient.prototype, {
  ...
  getLatest: function( browser, fn ) {
    ...
    process.nextTick(function() {
      fn( null, browser ? latest[ browserId ] : util._extend( {}, latest ) );
    });
  },
  ...
  // internal stuff
  serverHost: "api.browserstack.com",
  latest: null,
  latestUpdate: 0,
  latestPending: false,
...
module.exports = {
  createClient: function ( settings ) {
    ...
    util._extend( apiClient.prototype, versionSettings);
